 ...
 */
final class Version20221227093932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_has_product (id VARCHAR(255) NOT NULL, user_id VARCHAR(255) DEFAULT NULL, product_id VARCHAR(255) DEFAULT NULL, INDEX IDX_1DA0A5E3A76ED395 (user_id), INDEX IDX_1DA0A5E34584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
